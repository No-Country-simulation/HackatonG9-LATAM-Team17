...
@Schema(description = "DTO de entrada para el análisis financiero del usuario")
public record AnalisisInputDTO(
        ...
        @Schema(
                description = "Nivel de endeudamiento estimado (porcentaje o escala)",
                example = "30",
                requiredMode = Schema.RequiredMode.REQUIRED
        )
        ...
        @Schema(
                description = "Monto destinado a inversiones",
                example = "50000.00",
                requiredMode = Schema.RequiredMode.REQUIRED,
                minimum = "0.0"
        )
